                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <a href="#"
                                class="rounded-md px-3 py-2 text-sm font-medium text-yellow-900 hover:bg-yellow-700   hover:text-white">Team</a>
                            <a href="#"
                                class="rounded-md px-3 py-2 text-sm font-medium text-yellow-900 hover:bg-yellow-700   hover:text-white">Projects</a>
                            <a href="#"
                                class="rounded-md px-3 py-2 text-sm font-medium text-yellow-900  hover:bg-yellow-700   hover:text-white">Calendar</a>
                            <a href="#"
                                class="rounded-md px-3 py-2 text-sm font-medium text-yellow-900  hover:bg-yellow-700  hover:text-white">Reports</a>
                        </div>
                    </div>
                </div>
                <div class="hidden md:block">
